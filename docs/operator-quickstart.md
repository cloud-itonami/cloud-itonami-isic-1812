# Operator Quickstart — Community Print Support Services Operations

Shortest path from clone to a verified local dry-run for **ISIC 1812** (`cloud-itonami-isic-1812`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1812.git
cd cloud-itonami-isic-1812
```
...
- Blueprint governor key: `print-support-governor`
- Likely source path: `src/**/print-support-governor.cljc`
